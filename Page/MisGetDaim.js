...
export default class MisGetDaim extends PageBase{
    ...
    pageInit(){
        ...
        this.viewProp.m_misBtn.on(Laya.Event.CLICK,this,function(){
            G_Tools.btnAction(this.viewProp.m_misBtn);
            this.onClickBtn();
        });
                ...
                let openGetFun=function(){
                    Laya.timer.once(2000,this,function(){//延时显示goldview
                        ...
                        vals.closeFun=function(){
                            G_MainGui.closeUI(G_UIName.MisGetDaim);
